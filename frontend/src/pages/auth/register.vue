    ...
    <div class="relative rounded-lg">
      <div class="px-6 py-6 lg:px-8">
        <div class="flex items-start text-center gap-3">
          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Register in</h3>
          <div class="font-bold text-lg flex items-center gap-x-2">
            ...
            <div class="tracking-wide dark:text-white">CineHall<span class="text-red-600">.</span></div>
          </div>
        </div>
        <form class="space-y-6 py-10" action="#" @submit="checkForm">
          <div class="form-groupe">
            ...
            <input
              ...
              :class="errors['firstName'] ? ' border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:border-red-400' : ''"
          ...
          <div class="form-groupe">
            ...
            <input
              ...
              class="bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
              :class="errors['lastName'] ? ' border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:border-red-400' : ''"
          ...
          <div class="form-groupe">
            ...
            <input
              ...
              class="bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
              :class="errors['email'] ? 'border border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:border-red-400' : ''"
              v-model="this.email"
            />
          ...
          <div class="text-sm font-medium text-gray-500 dark:text-gray-300 pt-5">
            Have a account ?
            <router-link to="/login" class="text-[#f5c518] hover:underline dark:text-[#cba724]"> Log in </router-link>
          </div>
        </form>
      </div>
    </div>
  ...
  methods: {
    ...
    async checkForm(e) {
      ...
      if (!this.firstName) {
        ...
        this.errors["firstName"] = "First Name must be less than 20 characters.";
        flag = true;
      ...
      let email = true;
      if (this.email && !this.email.toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)) {
        ...
        .then((result) => {
          ...
          if (result.data.success) {
            ...
            Swal.fire({
              position: "center",
              icon: "success",
              title: "welcom <p class='text-red-600'>" + this.firstName + "</p><br>" + result.data.message,
